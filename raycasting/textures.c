...
/*   Updated: 2025/04/09 13:18:31 by ehafiane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void calculate_wall_dimensions(double distance, double ray_angle, double player_angle,
                            double fov, int *wall_top, int *wall_bottom)
{
    // Fisheye correction
